namespace CarRental.DataAccess.Migrations
{
    ...
    public partial class Initial_data : DbMigration
    {
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Reservations", "Availability_Id", "dbo.Availabilities");
            DropForeignKey("dbo.Availabilities", "Vehicle_Id", "dbo.Vehicles");
            ...
            DropIndex("dbo.Reservations", new[] { "Availability_Id" });
            DropIndex("dbo.Vehicles", new[] { "VehicleType_Id" });
            DropIndex("dbo.Cities", new[] { "Country_Id" });
            DropIndex("dbo.Availabilities", new[] { "Vehicle_Id" });
